...
export const EMAIL_SMTP_PASS: string = process.env.EMAIL_SMTP_PASS || "bpob bydf tdds gzwy";
export const EMAIL_SMTP_USER: string = process.env.EMAIL_SMTP_USER || "abdurrohmanbilaol.2008@gmail.com";
